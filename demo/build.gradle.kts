...
/*
 * S-52 v0.5.5 supplies the symbol/color catalogue used by this project through
...
val checkExternalS52Resources by tasks.registering {
    group = "verification"
    description = "Checks that S-52 v0.5.5 is used without legacy raster atlas runtime downloads."
    doLast {
