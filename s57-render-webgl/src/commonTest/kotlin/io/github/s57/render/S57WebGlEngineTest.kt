...
class S57WebGlEngineTest {
    ...
    fun importsListsAndRendersStaticCell() {
        ...
        val dataset = S57Dataset(
            ...
            features = listOf(
                ...
                S57Feature(id = 2, objectClass = "BOYLAT", geometry = S57Geometry.Point(GeoPoint(-73.95, 40.05)))
            )
        )
    ...
    fun centerCrosshairReturnsPointedFeature() {
        ...
        val dataset = S57Dataset(
            ...
            features = listOf(S57Feature(id = 10, objectClass = "SOUNDG", geometry = S57Geometry.Point(GeoPoint(-73.95, 40.05))))
        )
        val engine = S57WebGlEngine()
